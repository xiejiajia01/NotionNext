...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'gitbook',//'simple', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  //BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '黔ICP备2022008054号-1', // 备案号 闽ICP备XXXXXXX
